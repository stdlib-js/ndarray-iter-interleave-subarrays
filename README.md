...
```javascript
nditerInterleaveSubarrays = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-iter-interleave-subarrays@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-iter-interleave-subarrays/tags). For example,

```javascript
nditerInterleaveSubarrays = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-iter-interleave-subarrays@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var nditerInterleaveSubarrays = require( 'path/to/vendor/umd/ndarray-iter-interleave-subarrays/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-iter-interleave-subarrays@umd/browser.js"></script>
```
...
(function () {
    window.nditerInterleaveSubarrays;
})();
</script>
```
...
[test-image]: https://github.com/stdlib-js/ndarray-iter-interleave-subarrays/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/ndarray-iter-interleave-subarrays/actions/workflows/test.yml?query=branch:v0.1.1
